...
# A test script to query the electric_data database based on date/time picker inputs from the frontend
# Return results as a Pandas DataFrame / Jsonified output object.
